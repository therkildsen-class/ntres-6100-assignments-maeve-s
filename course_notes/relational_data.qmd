...
Now, we are going to subset the flights data to make it easier to work with. We are going to pull the airline codes with a left join. Left join will be used in the vast majority of cases. In a left join, all of the data in the original dataframe will be kept unchanged, it will only be added to.
